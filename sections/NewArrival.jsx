  ...
  return (
    <Section ref={ref} id="fixed-target" className="new-arrival">
      ...
      <Container ref={ScrollingRef}>
        <Photos img="/Images/img11.webp" name="Denim" />
        <Photos img="/Images/img12.webp" name="Cool Dresses" />
        <Photos img="/Images/img13.webp" name="Jackets" />
        <Photos img="/Images/img14.webp" name="T-shirts" />
      </Container>
