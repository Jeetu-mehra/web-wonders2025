  ...
  return (
    <>
      ...
      <header className="hero relative h-screen flex items-center justify-center text-center"
        style={{
          backgroundImage: "url('https://sethukrishna.com/cdn/shop/articles/Red_Collage_Valentine_Gift_Ideas_ffb69197-9eb3-4b7c-ab73-dd5cdae6ef3e.jpg?v=1688789661')",
