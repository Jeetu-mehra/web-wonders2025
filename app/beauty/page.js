...
const beau = () => {
  ...
  return (
    <>
      <Head>
        <title>Beauty Collections</title>
        <link
      ...
      <header className="hero relative h-screen flex items-center justify-center text-center"
        style={{
          backgroundImage: "url('https://orane.com/wp-content/uploads/2020/04/99.-Best-Beauty-Academy-scaled-1-1536x1024.jpg')",
